    ...
    >
      ...
      >
        <div className={"overflow-y-auto px-1"}>
          <div>
            <h2 className={"text-2xl text-indigo-600"}>Final</h2>
          ...
          <div className={"grid grid-cols-8 my-3 text-md gap-3 font-semibold"}>
            ...
            <p className={"col-span-4 px-3 py-1 bg-indigo-600 text-white"}>
              Grand total
            </p>
            <p className={"col-span-4 flex justify-start py-1 text-indigo-700"}>
              {infos.prices.gt ? (
                ...
                <input
                  ...
                  className={`w-full outline-none px-3 py-2 md:w-40 uppercase ${
                    checkintext.buttontext === "Purchased"
                      ? "bg-green-600"
                      : "bg-indigo-600"
                  }  text-white hover:bg-indigo-800 focus:bg-indigo-600 focus:animate-spin `}
                />
              </div>
            </div>
          </div>
        ...
        <input
          ...
          className={
            ...
            "text-indigo-700 shadow-md bg-gray-200 font-medium hover:text-white hover:bg-red-600  focus:bg-red-700 focus:ring-4"
          }
          value={"close"}
          onClick={handleClose}
        />
